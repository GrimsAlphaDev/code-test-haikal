...
@section('content')
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-700">Edit Menu</h1>
    ...
    <div class="mt-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <form action="{{ route('merchant.menu.update', $menu->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="description" id="description"
                            ...
                            rows="4">{{ (old('description')) ? old('description') : $menu->description }}</textarea>
                    </div>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <div class="mt-4">
                        ...
                        <input type="text" name="price" id="price" 
                            ...
                            // delete the dot and number after the dot
            ...
            <div>
                ...
                <div id="previewImg">
                    <img src="{{ asset('images/' . $menu->photo) }}" class="w-128 h-128 object-cover rounded-md border border-gray-200">
                </div>
            </div>
        </div>
    </div>
